...
//        echo '</table>';
                ?>
               <P> 搜尋會員：</p><input type="search" class="light-table-filter" data-table="order-table" placeholder="請輸入關鍵字">
                ...
                <table id="table-3" class="order-table"   >
                    ...
                    <tbody>
                        ...
                        while ($row = $result->fetch(PDO::FETCH_OBJ)) {
                            ...
                            . "<td>" . $row->帳號儲存方式 . "</td>"
                            . "<td>" . $row->語言 . "</td>"
                            . "<td> <button type=\"button\" onclick='location.href=\"delete.php?id=". $row->會員編號."\"'>刪除</button></td>";
