    ...
    <body>
        ...
        if (isset($_POST["Reg"])) {
            ...
            if ($sure) {
                ...
                $db = DB();
                $sql = "UPDATE \"會員資料\" \n" .
                        "SET \"會員編號\" = ".$_SESSION["member_account"].",\n" .
                        "\"暱稱\" = '".$_POST["member_nickname"]."',\n" .
                        "\"帳號儲存方式\" = '".$_POST["member_store"]."',\n" .
                        "\"儲存語言\" = '".$_POST["member_laguage"]."',\n" .
                        "WHERE\n" .
                        "	\"顧客編號\" =" . $_SESSION["idNum"];
...
//                header("Location:all.php");
        ...
        <div class="container">          
            ...
            <div class="content">
                ...
                <p>會員編號:<?php echo $_SESSION["idNum"]; ?></p>
                <br>
                <br>
                ...
                <form method="post" action="">
                    ...
                    <div class="6u 12u$(small)"> <p>會員帳號：</p>
                        <input type="text" name="member_account" id="member_account" value="<?php echo $_SESSION["member_account"]; ?>" placeholder="member_account" required>
                    </div>

                    <br/>
                    <div class="6u 12u$(small)"> <p>暱稱：</p>
                        <input type="text" name="member_nickname" id="member_nickname" value="<?php echo $_SESSION["member_nickname"]; ?>" placeholder="member_nickname" required>
                    </div>
                    <br/>

                    <div class="6u 12u$(small)"> <p>帳號儲存方式</p>
                        <input type="text" name="member_store" id="member_store" value="<?php echo $_SESSION["member_store"]; ?>" placeholder="member_store" required>
                    </div>
                    <br/>

                    <div class="6u 12u$(small)"> <p>儲存語言</p>
                        <input type="text" name="member_language" id="member_language" value="<?php echo $_SESSION["member_language"]; ?>" placeholder="member_language" required>
                    </div>
                    <br/>
